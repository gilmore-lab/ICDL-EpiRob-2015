...
![Gilmore-Raudies-Jayaraman-Fig-1](figs/fig-1.pdf)
...
```{r simulation-histogram, echo=FALSE, warning=FALSE, message=FALSE, include=FALSE}
# Load simulation histogram data
dir.data = "../data/simulation-data"
fn.data = paste(dir.data, "HistogramFromTheory.csv", sep="/")
df.in <- read.csv( fn.data, header=FALSE )
...
### Plot Speed Effects By Posture

```{r, simulation-histogram-plot, echo=FALSE, warning=FALSE, message=FALSE, include=FALSE}
